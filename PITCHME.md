...
<ul class="fragment">
<li> freertos  @fa[arrow-right fa-green] analisi generalmente semplice </li>
<li> linux <em>embedded</em>  @fa[arrow-right fa-red] progetti complessi, da analizzare in tre fasi
